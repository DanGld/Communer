...
//		expandedTabLayoutParams = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f);
	...
	private void addIconTab(final int position, int resId) {
		if (position != 2){
			...
			View tabView = inflater.inflate(R.layout.icon_with_text, null);

			ImageView btn = (ImageView)tabView.findViewById(R.id.tab_layout_image);
			TextView textView = (TextView)tabView.findViewById(R.id.tab_layout_text);
