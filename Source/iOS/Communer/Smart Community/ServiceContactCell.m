...
@implementation ServiceContactCell
...
-(void)setStars {
    if ([_contactRating.text doubleValue]>1)
        [_star1 setImage:[UIImage imageNamed:@"orange_star"]];
    
    if ([_contactRating.text doubleValue]>2)
        [_star2 setImage:[UIImage imageNamed:@"orange_star"]];
    
    if ([_contactRating.text doubleValue]>3)
        [_star3 setImage:[UIImage imageNamed:@"orange_star"]];
    
    if ([_contactRating.text doubleValue]>4)
        [_star4 setImage:[UIImage imageNamed:@"orange_star"]];
    
    if ([_contactRating.text doubleValue]==5)
        [_star5 setImage:[UIImage imageNamed:@"orange_star"]];
}
